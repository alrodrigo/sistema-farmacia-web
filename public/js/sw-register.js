...
(function() {
  ...
  function showUpdateNotification() {
    ...
    notification.innerHTML = `
      ...
      ">
        ...
        <div>
          <div style="font-weight: 600; font-size: 15px;">✅ Actualizado a v4.0.1789654912</div>
  ...
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('/sw.js?v=4.0.1789654912')
      .then((registration) => {
        console.log('✅ Service Worker registrado:', registration.scope);
        
        // Forzar chequeo de actualización inmediata en cada carga de página
        registration.update();
